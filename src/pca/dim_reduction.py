...
def lower_dim(z_dim):
    sdss_test_df = pd.read_pickle(os.path.join('src/results/latent-vectors', 'sdss', 'test.pkl'))
    ...
    # plt.legend(loc='best')
    plt.tight_layout()
    fig.savefig('src/pca/results/explained_var_ratio.png', bbox_inches='tight')
