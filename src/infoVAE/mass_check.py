...
def main():
    ...
    mass_list = []
    for file_name in os.listdir('./tsne/selected_sdss'):
    ...
    plt.savefig('./mass_check/selected_mass_hist.png')
    plt.close()
    ...
    plt.savefig('./mass_check/mass_hist.png')
    plt.close()
