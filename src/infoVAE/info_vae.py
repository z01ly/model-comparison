# github repo: PyTorch-VAE
# Adapted from https://github.com/AntixK/PyTorch-VAE/blob/master/models/info_vae.py
...
from src.infoVAE.base import BaseVAE
...
class InfoVAE(BaseVAE):
    ...
    def loss_function(self,
        ...
        mmd_loss = self.compute_mmd(z, kwargs['current_device'])
    ...
    def compute_mmd(self, z: Tensor, current_device: int) -> Tensor:
        # Sample from prior (Gaussian) distribution
        prior_z = torch.randn_like(z)
        prior_z.requires_grad_(False)
        prior_z = prior_z.to(current_device)
